        ...
        <header class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('user.dashboard.project.export', $project->id) }}" class="px-4 py-2 bg-gray-700 rounded-lg text-gray-300 hover:bg-gray-600 transition-all flex items-center">
